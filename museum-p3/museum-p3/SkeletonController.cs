...
namespace SkeletalTracking
{
    class SkeletonController
    {
        ...
        public void resetTargets(Dictionary<int, Target> targets)
        {
            ...
            for (int i = 1; i <= 5; i++)
            {
                if (targets[i].isHidden())
                {
                    targets[i].showTarget();
                }
                targets[i].setTargetUnselected();
                targets[i].setTargetText("" + i);
                targets[i].setTargetTextSize(40);
                targets[i].setTargetTextPadding("27,10,0,0");
                targets[i].setTargetTextAlign(TextAlignment.Left);
            }
        }
    ...
    public class Target
    {
        ...
        public void setTargetTextSize(int size)
        {
        ...
        public void setTargetTextAlign(TextAlignment align)
        {
            _canvasEl.TextAlignment = align;
        }
